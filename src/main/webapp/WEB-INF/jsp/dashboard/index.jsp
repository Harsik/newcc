  ...
  <div class="container">
    <div id="slides">
				 <div class="img" id="wrap" style="margin:0px; padding:0px;">
						<div id="header">
							<div class="inner">
								...
								<div class="date" style="padding-left:58px;"> 
									<span class="time" id="idx_curDate1"></span>
									<span class="time" id="curTime1"></span>
								</div>
							</div>
						</div>
						<div class="middle">
							<div class="left-section">
								<div class="top-value">
									...
									<span class="t-value" id="idx_custWait">0</span>
								</div>
								<ul class="value">
									<li>
										<div class="item">로그인 상담사</div>
										<div class="value"><span class="num" id="idx_agentLogin">20</span> 명</div>
									</li>
									<li>
										<div class="item">상담대기</div>
										<div class="value"><span class="num" id="idx_agentReady">3</span> 명</div>
									</li>
									<li>
										<div class="item">상담처리</div>
										<div class="value"><span class="num" id="idx_agentBusy">20</span> 명</div>
									</li>
									<li>
										<div class="item">상담 후 업무처리</div>
										<div class="value"><span class="num" id="idx_afterWork">20</span> 명</div>
									</li>
									<li>
										<div class="item">서비스 레벨</div>
										<div class="value"><span class="num" id="idx_serviceLevel">100</span> %</div>
									</li>
								</ul>
							</div>
							<div class="right-section">
								<div class="top-value">
									...
									<span class="t-value" id="idx_IbObCall">1,200</span>
								</div>
								<ul class="value">
									<li>
										<div class="item">인입호</div>
										<div class="value"><span class="num" id="idx_totalCall">1,900</span> 건</div>
									</li>
									<li>
										<div class="item">IB</div>
										<div class="value"><span class="num" id="idx_inbound">1,000</span> 건</div>
									</li>
									<li>
										<div class="item">OB</div>
										<div class="value"><span class="num" id="idx_outbound">300</span> 건</div>
									</li>
									<li>
										<div class="item">포기호</div>
										<div class="value"><span class="num" id="idx_abandon">10</span> 건</div>
									</li>
									<li>
										<div class="item">응답율</div>
										<div class="value"><span class="num" id="idx_answerRate">98.7</span> %</div>
									</li>
								</ul>
							</div>
						</div>
			  	...
			  	<div class="img page2" id="wrap">
						<div id="header">
							<div class="inner">
								...
								<div class="date" style="padding-left:58px;"> 
									<span class="time" id="idx_curDate2"></span>
									<span class="time" id="idx_curTime2"></span>
								</div>
							</div>
						</div>
						<div class="middle">
							<div class="all-section" >
								  <div class="g-title">&nbsp; </div>  
								 	<div class="graph" id="idx_pie_div2" style="width: 53%; margin-left:25%; height: 570px;text-align:center;">			
								</div>
								<div class="table" style="position: relative;">
									<table>
										...
										<tr>
											<td id="idx_administCount01">30건</td>
											<td id="idx_administCount02">30건</td>
											<td id="idx_administCount03">30건</td>
											<td id="idx_administCount04">10건</td>
											<td id="idx_cnslCountt02" style="color:#009e71;">2,000건</td>
										</tr>
									</table>
								</div>
			 	...
			 	<div class="img page3" id="wrap">
						<div id="header">
							<div class="inner">
								...
								<div class="date" style="padding-left:58px;"> 
									<span class="time" id="idx_curDate3"></span>
									<span class="time" id="idx_curTime3"></span>
								</div>
							</div>
						</div>
						<div class="middle">
							<div class="all-section" >
								<div class="graph3" id="idx_chart_div" style="width: 100%; height: 640px;">
								</div>
								<div class="table" style="position: relative;">
									<table>
										<thead>
										...
										<tr>
											<td id="idx_cnslCount01">2건</td>
											<td id="idx_cnslCount02">4건</td>
											<td id="idx_cnslCount03">4건</td>
											<td id="idx_cnslCount04">8건</td>
											<td id="idx_cnslCount08">12건</td>
											<td id="idx_cnslCount05">12건</td>
											<td id="idx_cnslCount06">30건</td>
											<td id="idx_cnslCount07">40건</td>
										</tr>
									</table>
								</div>
									...
									<table>
										...
										<tr>
											<td id="idx_cnslCountt03" style="color:#009e71;">2,000건</td>
 		...
 		<div id="footer">
			...
			<div class="logo">
				<img src="/resources/images/pyeongtaek_logo.png" id="imgConfSet" alt="">
			</div>
	 </div> 
</body>
</html>