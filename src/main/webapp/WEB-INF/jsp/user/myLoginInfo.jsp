...
<html lang="ko">
    <head>
        ...
        <script type="text/javascript" src="<c:url value='/resources/js/user/myLoginInfo.js'/>"></script>
    ...
    <body>
        <div id="h1">접속 이력관리 </div>
        <div id="pop_body">
            <div class="stitle">접속조회</div>
        <div id="search">
            <table class="search_tbl">
                <tr>
                    ...
                    <td class="nemo_20">
                        <input type="text" class="text_ol" id="idSrchVal" maxlength="20">
                    </td>
                    <!-- <th></th> -->
                    <th style="padding-left: 14px;">로그인일자</th>
                        <td class="nemo_50">
                            <input type="text" class="text_ol_half" id ="loginInfoDtStr" readOnly style="text-align: center;">
                            <label> ~ </label>
                            <input type="text" class="text_ol_half" id ="loginInfoDtEnd" readOnly style="text-align: center;">
                        </td>
                        <td id="nemo_30" class="nemo_30" style="left: 730px;font-weight:bold;">
        ...
        <div class="stitle">접속이력</div>
            ...
            <table style="width:100%; height:200px;">
                ...
                <tr>
                    <td>         
                        <table id="loginInfoList"></table>
                        <div id="pgLoginInfoList"></div>
                    </td>
                </tr>
            </table>
            </div>
