				...
				<table summary="상담이력조회" class="search2_tbl">
					...
					<tr>
						...
						<td colspan="3">
							...
							<select class="select_al" style="width:150px;" id="cslist_selSrchIntvSmCd" title="소분류"></select>
						</td>
...
<!-- 								<option value="srchKeyWord">키워드</option> -->
								<option value="srchAddr">주소</option>
							</select>
						</td>
						<td colspan="2">
...
<!-- 								<select class="select_bl" style="width:113px;" id="cslist_selSrchKeyWordCd" title="검색구분"></select> -->
								<select class="select_bl" style="width:113px;" id="cslist_selSrchAddrCd" title="검색구분"></select>
						</td>
						<!-- <th>민원처리결과</th>-->
						<!-- <td> -->
						...
						<th>수신동의</th>
						<td>
							<select class="select_al" id="cslist_selInfoAgree"  style="width:60px;"><option value="">전체</option><option value="N">아니오</option><option value="Y">예</option></select>
						</td>
