...
<%
	System.out.println("쿠쿠닥스 UPLOAD START");
    /*
    ...
    String UPLOAD_FOLDER_PATH = "/shared/AgentApp/editor"; // server path
//     String UPLOAD_FOLDER_PATH = "D:/shared/AgentApp/editor"; // local path
    String URL_PATH = "/AgentApp/editor"; // ex) "http://www.kukudocs/upload"
    ...
    if (isMultipart) {
		...
		String ls_path = "/" + ls_date.substring(0, 4) + "/" + ls_date.substring(4, 6); // ex ) /2021/10
		String ls_folder_path = UPLOAD_FOLDER_PATH + ls_path;
		String ls_url_path = URL_PATH + ls_path;
    	
        File directory = new File(ls_folder_path);
            ...
            if(fileItem.isFormField()){
                ...
                if (type.equals(UPLOAD_IMAGE_BASE64_TYPE)) {
                    try {
                        ...
                        FileOutputStream fos = new FileOutputStream(ls_folder_path + "/" + fileName); //change path of image according to you
                        
                        byte[] byteArray = Base64.decodeBase64(imageDataBytes.getBytes());
                        fos.write(byteArray);
                        fos.flush();
                        fos.close();

                        msg = ls_url_path + "/" + fileName;
                    } catch (Exception e) {
                        isError = true;
                ...
                if(fileItem.getSize() > 0){
                    ...
                    if (fieldName.equals(UPLOAD_IMAGE_TYPE)
                        ...
                        try{
                            ...
                            //File Save
                            File uploadedFile = new File(ls_folder_path, fileName);
